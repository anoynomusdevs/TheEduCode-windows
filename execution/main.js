...
async function verifyFileIntegrity() {
    const checksums = {
        ...
        'package.json': '140568cb3d5b0b998b549fe523cf3e851e42c39f229b6697225da331c3b7ed49',
        'webviewPreload.js': '5e460a651c85e39fd025a96ec1554fabf6a9a1acb00c4aad262c1ea9bdab7a4c',
        'main.loader.js': '8132c14140ed9f5a8c33dc4f85eb7433d0205372a1909d8735558f66e374103a',
    ...
    for (const [filename, expectedHash] of Object.entries(checksums)) {
        // Handle unpacked asar path for bin/ files
        const fullPath = filename.startsWith('bin/') && app.isPackaged
            ? path.join(process.resourcesPath, 'executables', filename.substring(4))
...
async function getMasterKey() {
    const enData = await robustFetch("https://g6y8h3p2k0.theeducode.com/getKey");
